                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="#"
                                    class="underline text-gray-900 dark:text-white">Página de inicio</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Ejercicios sobre un proyecto de PHP Laravel.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="companies"
                                    class="underline text-gray-900 dark:text-white">Compañías</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <p>Ejercicio de operaciones CRUD sobre base de datos</p>
                                <p>Código elaborado a partir de <a href="https://techvblogs.com/blog/laravel-9-crud-application-tutorial-with-example"
                                    class="underline text-gray-900 dark:text-white">este tutorial</a>.</p>
                            </div>
                        </div>
                    </div>

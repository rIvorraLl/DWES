...
<body>
    <main>
        <div>
            ...
            function imprimirConInput()
            {
                echo '<form action="" method="post">
                    <label for="ins">Escoge un algoritmo</label>
                    <select name="inputs">
                        <option value="bubble">Burbuja</option>
                        <option value="insercion">Inserción</option>
                        <option value="seleccion">Selección directa</option>
                        <option value="intercambio">Intercambio</option>
                    </select>
                    <input type="submit"name="submit"value="Selecciona">';
                if (isset($_POST['submit']))
                {
                    ...
                    {
                        echo 'Por favor, selecciona un valor.';
                    }
                }
            }
            imprimirConInput();
